...
function hz(num1,num2) {
	return new Promise((resolve) => {
		let url = {
			url: `https://xpph7.happydoit.com:8090/farmApi/saveFarmHelpOther?handOpenId=${mecohzArr[num1]}&openid=${mecohzArr[num2]}`,
			headers: {

				'Host': 'xpph7.happydoit.com:8090',
			},
			body: '',
		}
